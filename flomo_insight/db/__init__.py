...
# V4: track whether LLM has optimized this memo's tags.
# NULL → not yet processed by LLM tagging; ISO timestamp → done.
SCHEMA_V4 = """
ALTER TABLE memos ADD COLUMN tags_llm_at TEXT;
"""
